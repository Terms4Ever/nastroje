...
| `kontrola-dokumentace.php` | 1.7.0 | [08 soubory a dokumentace](08-soubory-a-dokumentace.md) |
...
| `tests/spust.php` (72 případů), `tests/kompatibilita.php` | - | [04 ověření](04-overeni.md) |
